...
public class BookRepository {
    ...
    public Book getBook(int id){
        ...
        try {
            ...
            String sql = "SELECT id, book_name, author, year FROM books WHERE id = ?;"; // the string with the request.
            // * means SELECT all columns FROM the table books WHERE id is inputted from console!
    ...
    public Book getBookByNameAndYear(String bookName, int year){
        ...
        try {
            con = db.getConnection();
            String sql = "SELECT id, book_name, author, year FROM books WHERE book_name = ? AND year = ?;";
    ...
    public Book createBook(Book book) {
        ...
        try {
            con = db.getConnection();
            String sql = "INSERT INTO books (book_name,author,year) VALUES (?,?,?)";
            PreparedStatement st = con.prepareStatement(sql);
